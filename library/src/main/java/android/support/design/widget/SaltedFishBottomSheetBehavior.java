 ...
 * a bottom sheet.
 */
public class SaltedFishBottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
     ...
     */
    public SaltedFishBottomSheetBehavior() {
    }
     ...
     */
    public SaltedFishBottomSheetBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    void invalidateScrollingChild(View scrollView) {
        mNestedScrollingChildRef = new WeakReference<>(findScrollingChild(scrollView));
    }
    ...
    View findScrollingChild(View view) {
        ...
        if (view instanceof ViewPager) {
            ...
            if (scrollingChild != null && ViewCompat.isNestedScrollingEnabled(scrollingChild)) {
    ...
    public static <V extends View> SaltedFishBottomSheetBehavior<V> from(V view) {
        ...
        CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) params)
                .getBehavior();
        if (!(behavior instanceof SaltedFishBottomSheetBehavior)) {
            throw new IllegalArgumentException(
                    "The view is not associated with BottomSheetBehavior");
        }
        return (SaltedFishBottomSheetBehavior<V>) behavior;
    }
